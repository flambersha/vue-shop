<script setup>
  ...
  function updateQuantity(change) {
    ...
    if (newValue >= 1 && newValue <= props.item.available) {
...
<template>
    <div v-if="showModal" class="fixed inset-0 flex justify-center items-center z-50">
      ...
      <div class="relative z-10 w-full max-w-md bg-(--cart-bg) rounded-lg shadow-xl">
        <!-- Modal Header -->
        ...
        <div class="p-4 border-b">
          <div class="flex items-start">
              <div class="h-16 w-16 bg-(--rounded-elements) rounded-md">
        ...
        <div class="p-4">
          ...
          <div class="mt-1 flex items-center">
            <button 
              ...
              class="p-2 rounded-l border border-r-0 border-gray-300 bg-gray-50 text-gray-500 hover:bg-gray-100 cursor-pointer"
              :disabled="quantity <= 1"
            ...
            <input 
              ...
              class="p-1 w-16 text-center border-y border-gray-300 focus:ring-indigo-500 focus:border-indigo-500" 
            />
            <button 
              @click="updateQuantity(1)" 
              class="p-2 rounded-r border border-l-0 border-gray-300 bg-gray-50 text-gray-500 hover:bg-gray-100 cursor-pointer"
            >
              <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
